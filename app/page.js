        ...
        <div className="grid md:grid-cols-2 gap-8 items-center pt-10 pb-20">
          ...
          <div className="space-y-6">
            <h1 className="text-5xl md:text-6xl font-extrabold leading-tight text-white">
              Daily Quiz, Daily Learn — <span className="text-yellow-400"> Let's Play Today!</span>
            </h1>
            
            <p className="text-lg text-gray-300 max-w-lg">
              Let's check your Knowledge on UPSC Subject. <br />Questions are generated by AI. <br /> Let's learn new and boost your UPSC preparation.
            </p>
